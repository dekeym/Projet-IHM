...
public class MyListAdapterHdefis extends ArrayAdapter<Course> {
	Context context;
	private int layoutResourceId;
	List<Course> listeDefis;
	
	public MyListAdapterHdefis(Context context, int resource, List<Course> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageView image = (ImageView) itemView.findViewById(R.id.rowLDImage);
		TextView dateCourse = (TextView) itemView.findViewById(R.id.rowLDdateCourse);
		TextView tempsCourse = (TextView) itemView.findViewById(R.id.rowLDDiffTempsCourse);
		TextView distance = (TextView) itemView.findViewById(R.id.rowLDdstvar);
