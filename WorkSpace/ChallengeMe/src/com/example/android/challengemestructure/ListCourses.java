...
public class ListCourses {
	...
	public ListCourses(String type){
		if (type == "train") {
			...
			listeCourses.add(new Course("course#1", "defi", "12/12/2014", "17:30", "07km", "00:31:00", R.drawable.compet, "-00:06:32", true));
			listeCourses.add(new Course("course#2", "defi", "12/12/2014", "17:30", "02km", "00:31:00", R.drawable.compet, "+00:06:32", false));
			listeCourses.add(new Course("course#3", "defi", "12/12/2014", "17:30", "03km", "00:31:00", R.drawable.compet, "+00:06:32", false));
			listeCourses.add(new Course("course#4", "defi", "12/12/2014", "17:30", "04km", "00:31:00", R.drawable.compet, "-00:06:32", true));
			listeCourses.add(new Course("course#5", "defi", "12/12/2014", "17:30", "05km", "00:31:00", R.drawable.compet, "-00:06:32", true));
		} else {
			listeCourses.add(new Course("course#1", "defi", "12/12/2014", "17:30", "07km", "00:31:00", R.drawable.run));
